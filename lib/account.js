...
var Account = function (_Component) {
	...
	(0, _createClass3.default)(Account, [{
		...
		value: function render() {
			...
			var others = (0, _objectWithoutProperties3.default)(_props, ['user', 'dispatch']);
...
var Signup = function (_Component3) {
	...
	(0, _createClass3.default)(Signup, [{
		...
		value: function render() {
			...
			var passwordError = _state.passwordError;
			var password2Error = _state.password2Error;
			var dispatch = this.props.dispatch;
...
var Signin = function (_Component4) {
	...
	(0, _createClass3.default)(Signin, [{
		...
		value: function render() {
			...
			var passwordError = _state2.passwordError;
...
var SMSRequest = function (_Component7) {
	...
	(0, _createClass3.default)(SMSRequest, [{
		...
		value: function render() {
			...
			var phone = _state3.phone;
			var tick = _state3.tick;
			var dispatch = this.props.dispatch;
