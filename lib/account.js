...
export default class Main extends Component{
    ...
    verifyPhone(){
        User.verifyPhone().then(function(){
    ...
    signup(){
        User.signup({}).then(null,function(e){
            this.setState({signupError:e})
        }.bind(this))
    }
    signin(){
        var{username:name,password}=this.refs
        name=name.getDOMNode().value
        password=password.getDOMNode.value
        User.signin({name,password}).then(null,function(e){
