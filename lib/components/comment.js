		...
		value: function render() {
			...
			var photo = {
				...
				onSelect: function onSelect(e) {
					return _file2.default.selectImageFile().then(function (url) {
						return _file2.default.upload(url);
					}).then(function (url) {
						return commentPhoto({ url: url });
					});
				}
			};
...
Comment.propTypes = {
	...
	commentText: _react.PropTypes.func,
	commentPhoto: _react.PropTypes.func,
...
exports.default = (0, _recompose.compose)((0, _recompose2.withMutation)(function (_ref3, data, client) {
...
}), (0, _recompose.getContext)({ muiTheme: _react.PropTypes.object }), (0, _recompose.mapProps)(function (_ref4) {
	...
	return {
		...
		commentPhoto: function commentPhoto(_ref7) {
			var url = _ref7.url;
