...
})), (0, _recompose.withState)("contact", "setContact"), (0, _recompose.withState)("token", "setToken", ""), (0, _recompose.withState)("name", "setName"), offline.notSupport, (0, _recompose2.withMutation)({
	name: "requestToken",
	promise: true,
