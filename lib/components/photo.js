...
var Photo = exports.Photo = function (_Component) {
    ...
    function Photo() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Photo.__proto__ || Object.getPrototypeOf(Photo)).call.apply(_ref, [this].concat(args))), _this), _this.state = { url: _this.props.src, toSelectWay: false }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(Photo, [{
        ...
        value: function render() {
            ...
            var _state = this.state,
                url = _state.url,
                toSelectWay = _state.toSelectWay;
            ...
            var _props = this.props,
                ...
                others = _objectWithoutProperties(_props, ["size", "cameraOptions", "overwritable", "onPhoto", "autoUpload", "getToken", "src", "onClick"]);
            ...
            if (toSelectWay) {
                ...
                toSelectWayr = _react2.default.createElement(
                    _materialUi.Dialog,
                    {
                        ...
                        onRequestClose: function onRequestClose() {
                            return _this2.setState({ toSelectWay: false });
                        }
                    },
        ...
        value: function handlePhoto(url) {
            ...
            if (autoUpload) {
                ...
                onPhoto && onPhoto(url, function (id, key, token) {
                    return (0, _file.upload)(url, { id: id, key: key }, token || getToken);
                });
            }
        }
    }, {
...
Photo.propTypes = {
    ...
    getToken: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.string]).isRequired
};
Photo.defaultProps = {
    width: 1024,
    height: 1024,
