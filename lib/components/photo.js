    ...
    _createClass(Photo, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                others = _objectWithoutProperties(_props, ['width', 'height', 'cameraOptions', 'overwritable', 'onPhoto', 'autoUpload', 'getToken']);

            others.onClick = this.selectOrTakePhoto.bind(this);
            if (url) {
                return _react2.default.createElement(
                    _materialUi.SvgIcon,
                    _extends({}, others, { viewBox: '0 0 ' + width + ' ' + height }),
                    _react2.default.createElement('image', { xlinkHref: url, height: height, width: width })
                );
            }
