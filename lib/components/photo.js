	...
	_createClass(Photo, [{
		...
		value: function render() {
			...
			var pic = null,
			    selectOrTaker = null;
			if (selectOrTake) {
				selectOrTaker = _react2.default.createElement(_materialUi.Dialog, {
					...
					actions: [_react2.default.createElement(_materialUi.FlatButton, {
						label: "\u9009\u62E9",
						primary: true,
						icon: _react2.default.createElement(_sdStorage2.default, { sizee: 60 }),
						...
						label: "\u7167\u76F8",
						primary: true,
						icon: _react2.default.createElement(_photoCamera2.default, { size: 60 }),
						onClick: function onClick() {
