...
module.exports = { //for testable
  ...
  withGetToken: (0, _recompose.compose)((0, _recompose.getContext)({ client: _propTypes2.default.object }), (0, _recompose.mapProps)(function (_ref2) {
    var client = _ref2.client,
        others = _objectWithoutProperties(_ref2, ["client"]);

    return _extends({}, others, {
      getToken: function getToken(key) {
        key = typeof key == "string" ? { key: key } : key;
        return client.runQL({ id: "file_token_Query", variables: key }).then(function (_ref3) {
  ...
  withFileCreate: (0, _recompose2.withMutation)({
    name: "createFile",
    promise: true,
    mutation: function mutation() {
      return require("./__generated__/file_create_Mutation.graphql");
    }
  })
};

{
  getToken: _graphql || (_graphql = function _graphql() {
    return require("./__generated__/file_token_Query.graphql");
  });
}