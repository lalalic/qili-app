var {React, Component, Router}=require('..'),
    {History}=Router,
...
export default class Main extends Component{
    render(){
        enhanceBack(this.context.history)
        var {onSelect, className, primary, ...others}=this.props,
            ...
            commands=this.props.items.map((command)=>{
                ...
                if((command.action).toLowerCase()=='back'){
                    ...
                    command.onSelect=()=>this.context.history.goBack()
                }
...
Main.contextTypes={history:Router.PropTypes.history}
...
class Comment extends Command{
    ...
    onSelect(){
        ...
        this.context.history.transitionTo("comment",{type:_name,_id:_id})
    }
}
Main.Comment=Comment
Comment.contextTypes={history:Router.PropTypes.history}
