...
CommandBar.contextTypes = { router: _propTypes2.default.object };
...
CommandBar.Share = (0, _reactRedux.connect)()((_temp = _class3 = function (_Component4) {
    ...
    return _class3;
}(_react.Component), _class3.propTypes = { message: _propTypes2.default.oneOfType([_propTypes2.default.object, _propTypes2.default.func]) }, _temp));
