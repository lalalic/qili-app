	...
	(0, _createClass3.default)(InfoForm, [{
		...
		value: function render() {
			...
			if (editing) {
				...
				var onEdit = _children$props.onEdit;
				var hintText = _children$props.hintText;
				var _value = _children$props.value;
				var primaryText = _children$props.primaryText;
				var _children$props$type = _children$props.type;
				var type = _children$props$type === undefined ? "input" : _children$props$type;
				var options = _children$props.options;
				var customizedEditor = _children$props.children;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					children.map(function (child, i) {
						...
						var onEdit = _child$props.onEdit;
						var hintText = _child$props.hintText;
						var value = _child$props.value;
						var primaryText = _child$props.primaryText;
						var _child$props$type = _child$props.type;
						var type = _child$props$type === undefined ? "input" : _child$props$type;
						var options = _child$props.options;
						var children = _child$props.children;
						var others = (0, _objectWithoutProperties3.default)(_child$props, ["onEdit", "hintText", "value", "primaryText", "type", "options", "children"]);
...
var Editor = {
	input: function input(_ref3) {
		...
		var hintText = _ref3.hintText;
		var value = _ref3.value;
		var primaryText = _ref3.primaryText;
		var page = _ref3.page;
	...
	single: function single(_ref4) {
		...
		var hintText = _ref4.hintText;
		var value = _ref4.value;
		var primaryText = _ref4.primaryText;
		var page = _ref4.page;
		var options = _ref4.options;
		var _ref4$len = _ref4.len;
		var len = _ref4$len === undefined ? options.length : _ref4$len;
	...
	multiple: function multiple(_ref5) {
		...
		var onCancel = _ref5.onCancel;
		var hintText = _ref5.hintText;
		var _ref5$value = _ref5.value;
		var v1 = _ref5$value === undefined ? [] : _ref5$value;
		var primaryText = _ref5.primaryText;
		var options = _ref5.options;
		var page = _ref5.page;
		var _ref5$selecteds = _ref5.selecteds;
		var selecteds = _ref5$selecteds === undefined ? [].concat((0, _toConsumableArray3.default)(v1)) : _ref5$selecteds;
	...
	date: function date(_ref6) {
		...
		var onCancel = _ref6.onCancel;
		var hintText = _ref6.hintText;
		var value = _ref6.value;
		var primaryText = _ref6.primaryText;
		var page = _ref6.page;
	...
	customized: function customized(_ref7) {
		...
		var onCancel = _ref7.onCancel;
		var hintText = _ref7.hintText;
		var value = _ref7.value;
		var primaryText = _ref7.primaryText;
...
var Title = function Title(_ref8) {
	...
	var primaryText = _ref8.primaryText;
	var isChange = _ref8.isChange;
