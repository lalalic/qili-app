var {React, Router,Component, UI:{CommandBar, List, Messager, Icons: {Message: {Http, Error, Warning, All}}}}=require('.'),
    App=require('./db/app'),
        ...
        return(
            <div>
                ...
                <CommandBar className="footbar" style={{textAlign:'left'}}
                    onSelect={(cmd)=>this.context.history.replaceWith("log",cmd=='All' ? null : {level:cmd.toLowerCase()})}
                    items={[{action:"Back"},
