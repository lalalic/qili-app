				...
				_react2.default.createElement(_commandBar2.default, { className: "footbar",
					items: [{ action: "Back" }, { action: "Save", label: "保存", icon: _react2.default.createElement(_save2.default, null),
						onSelect: function onSelect(a) {
							return create({ name: refName.getValue, uname: refUname.getValue() }).then(function (_ref9) {
								var _id = _ref9._id;
...
}), (0, _recompose.getContext)({ router: _react.PropTypes.object }))(Creator)), (0, _recompose.getContext)({
...
}), (0, _recompose2.withMutation)(function (_ref11, data) {
	var id = _ref11.id;
	return {
		name: "update",
		patch4: id,
...
}), (0, _recompose2.withMutation)(function (_ref12) {
	var id = _ref12.id;
	return {
		name: "doRemove",
		variables: { id: id },
...
}, function (dispatch, _ref13) {
	var doRemove = _ref13.doRemove,
	    doUpload = _ref13.doUpload,
	    name = _ref13.name,
	    router = _ref13.router,
	    showMessage = _ref13.showMessage,
	    switchApp = _ref13.switchApp,
	    id = _ref13.params.id;
	return {
