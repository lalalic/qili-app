...
export default class AppInfo extends Component{
        ...
        return (
            <div className="form">
                ...
                <TextField ref="url"
                    ...
                    fullWidth={true}
                    value={app.url}
                    onBlur={()=>this.change('url')}/>

                <TextField ref="clientCodeUrl"
                    floatingLabelText="code url: {url:a html file}<==app.qili2.com/{prouctName}"
                    fullWidth={true}
                    value={app.clientCodeUrl}
                    onBlur={()=>this.change('clientCodeUrl')}/>
    ...
    onSelect(command,e){
        ...
        case "Remove":
            ...
            if(name==app.name){
                App.remove(app._id,null,(e)=>{UI.Messager.error(e.message)})
