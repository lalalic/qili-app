...
var withMutation = function withMutation(option) {
	return function (BaseComponent) {
		...
		var WithMutation = (0, _recompose.getContext)({ client: _react.PropTypes.object })(function (_ref) {
			...
			function mutate(data) {
				var _ref3 = typeof option == "function" ? option(others, data, environment) : option,
				    ...
				    _ref3$shouldPatch = _ref3.shouldPatch,
				    shouldPatch = _ref3$shouldPatch === undefined ? function (o) {
				    ...
				    mutation = _objectWithoutProperties(_ref3, ["spread", "variables", "patch4", "patchData", "shouldPatch", "promise", "dateFields"]);
