...
exports.default = (0, _recompose.compose)((0, _recompose.setPropTypes)({
	...
	if (!store) {
		...
		(0, _reduxPersist.persistStore)(store, { keyPrefix: appId + ":" }, function () {
			return store.dispatch(ACTION.READY);
		});
	...
	return props;
}), (0, _recompose.branch)(function (_ref10) {
...
}, (0, _recompose.renderComponent)(function (_ref11) {
	...
	var AD = _ref12.AD,
	    adUrl = _ref12.adUrl;
	return !AD && adUrl;
}, (0, _recompose.renderComponent)(function (_ref13) {
	var doneAD = _ref13.doneAD,
	    adUrl = _ref13.adUrl;
	return _react2.default.createElement(_splashAd2.default, { url: adUrl, onEnd: doneAD });
})), (0, _recompose.branch)(function (_ref14) {
	var inited = _ref14.inited;
	return !inited;
}, _recompose.renderNothing), (0, _reactRedux.connect)(function (_ref15) {
	var user = _ref15.qili.user;
	return user !== undefined ? { user: user } : {};
}), (0, _recompose2.withGraphqlClient)("relay modern"), (0, _recompose.branch)(function (_ref16) {
	var user = _ref16.user;
	return !user || !user.token;
}, (0, _recompose.renderComponent)(function (_ref17) {
...
})), (0, _recompose.mapProps)(function (_ref18) {
