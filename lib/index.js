...
var Message = (0, _reactRedux.connect)(function (state) {
	return _extends({ level: "info", duration: 2000 }, state[DOMAIN].message);
})(function (_ref4) {
...
})), (0, _recompose2.withGraphqlClient)("relay modern"), (0, _recompose.branch)(function (_ref15) {
	var user = _ref15.user;
	return !user || !user.token;
}, (0, _recompose.renderComponent)(function (_ref16) {
	var theme = _ref16.theme,
	    store = _ref16.store,
	    setUser = _ref16.setUser;
	return _react2.default.createElement(
		_reactRedux.Provider,
		{ store: store },
		_react2.default.createElement(
...
})), (0, _recompose.mapProps)(function (_ref17) {
	var title = _ref17.title,
	    theme = _ref17.theme,
	    checkVersion = _ref17.checkVersion,
	    store = _ref17.store,
