...
exports.default = (0, _recompose.compose)((0, _recompose.setPropTypes)({
	...
	var _ref8$qili = _ref8.qili,
	    ...
	    inited = _ref8$qili.inited,
	    AD = _ref8$qili.AD,
	    tutorialized = _ref8$qili.tutorialized,
	    user = _ref8$qili.user;
	return {
		inited: inited, AD: AD, tutorialized: tutorialized, user: user
	};
	...
	return !inited;
}, _recompose.renderNothing), (0, _recompose2.withGraphqlClient)("relay modern"), (0, _recompose.branch)(function (_ref16) {
