		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					UI,
					{ muiTheme: theme },
					notifyOffline ? _react2.default.createElement(offline.Notification, null) : null,
					children,
...
QiliApp.propsTypes = {
	...
	notifyOffline: _propTypes2.default.bool
};
exports.default = (0, _recompose.compose)((0, _recompose.setPropTypes)({
	...
	notifyOffline: _propTypes2.default.bool,
	supportOffline: _propTypes2.default.object
	...
	var title = _ref19.title,
	    ...
	    isDev = _ref19.isDev,
	    notifyOffline = _ref19.notifyOffline,
	    supportOffline = _ref19.supportOffline;
