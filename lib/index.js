...
var REDUCER = exports.REDUCER = function REDUCER() {
	...
	switch (type) {
		...
		case "@@" + DOMAIN + "/NEXT_APP":
			...
			var next = current;
			return _extends({}, state, { current: next });
	}
...
exports.default = (0, _recompose.compose)((0, _recompose.setStatic)("render", function (app) {
	...
	if (!store) {
		...
		store = (0, _redux.createStore)((0, _redux.combineReducers)(_extends(_defineProperty({}, DOMAIN, REDUCER), reducers)), composeEnhancers((0, _redux.applyMiddleware)(_reduxThunk2.default)));
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			UI,
			{ muiTheme: theme },
			_react2.default.createElement(_authentication2.default, {
				onSuccess: setUser }),
			_react2.default.createElement(Loading, null),
			_react2.default.createElement(Message, null)
		)
	);
})), (0, _recompose.withContext)({ fetcher: _react.PropTypes.func }, function (_ref15) {
	var service = _ref15.service,
	    appId = _ref15.appId,
	    token = _ref15.user.token;
	return {
		fetcher: function fetcher(opt) {
