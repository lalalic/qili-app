	...
	_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.IndexRoute, { component: (0, _recompose.compose)((0, _recompose2.withQuery)({
					...
					var me = _ref9.me;
					return { data: me };
				}), (0, _recompose.getContext)({ router: _react.PropTypes.object }), (0, _recompose.mapProps)(function (_ref10) {
		...
		_react2.default.createElement(_reactRouter.Route, { path: "cloud", component: (0, _recompose.compose)((0, _reactRedux.connect)(function (_ref18) {
			...
			}), withCurrent())(_cloud4.default) }),
		_react2.default.createElement(_reactRouter.Route, { path: "log", component: (0, _recompose.compose)((0, _reactRedux.connect)(function (_ref21) {
			...
			}), withCurrent(), withNavigator())(_log2.default) })
	)
);
