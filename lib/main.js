...
var Current = (0, _recompose.compose)((0, _reactRedux.connect)(function (_ref2) {
	...
	var id = _ref3.id;
	return !id;
}, _recompose.renderNothing), (0, _recompose.getContext)({ client: _propTypes2.default.object }), (0, _recompose.withProps)(function (_ref4) {
...
var router = _react2.default.createElement(
	...
	_react2.default.createElement(
		...
		_react2.default.createElement(_reactRouter.IndexRoute, { component: (0, _recompose.compose)(withCurrent(), withNavigator())(_dashboard4.default) }),
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: "my" },
			_react2.default.createElement(_reactRouter.IndexRoute, { component: (0, _recompose.compose)(withNavigator(), (0, _recompose2.withQuery)({
					...
					var me = _ref9.me;
					return { data: me };
				}), (0, _recompose.getContext)({ router: _propTypes2.default.object }), (0, _recompose.mapProps)(function (_ref10) {
		...
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: "app" },
			_react2.default.createElement(_reactRouter.IndexRoute, { component: (0, _recompose.compose)((0, _recompose.getContext)({ router: _propTypes2.default.object }), (0, _recompose.mapProps)(function (_ref12) {
		...
		_react2.default.createElement(_reactRouter.Route, { path: "comment/:id", component: (0, _recompose.compose)(withCurrent(), (0, _recompose2.withPagination)(function (_ref16) {
		...
		_react2.default.createElement(_reactRouter.Route, { path: "cloud", component: (0, _recompose.compose)(withCurrent(), (0, _reactRedux.connect)(function (_ref18) {
				var current = _ref18.qili.current;
				return {
					id: current
				};
			}), (0, _recompose2.withQuery)(function (_ref19) {
				var id = _ref19.id;
				return {
					variables: { id: id },
			...
			}), (0, _recompose.mapProps)(function (_ref20) {
				var data = _ref20.data,
				    others = _objectWithoutProperties(_ref20, ["data"]);

				return _extends({
					app: data.me.app
				}, others);
			}))(_cloud4.default) }),
		_react2.default.createElement(_reactRouter.Route, { path: "log", component: (0, _recompose.compose)(withCurrent(), withNavigator(), (0, _reactRedux.connect)(function (_ref21) {
				var current = _ref21.qili.current;
				return {
					id: current
				};
			}), (0, _recompose2.withPagination)(function (_ref22) {
				var id = _ref22.id,
			...
			}), (0, _recompose.mapProps)(function (_ref24) {
				var logApp = _ref24.logApp,
				    data = _ref24.data,
				    relay = _ref24.relay;
				return {
