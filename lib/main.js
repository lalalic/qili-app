...
var router = _react2.default.createElement(
	...
	_react2.default.createElement(
		...
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: "app" },
			_react2.default.createElement(_reactRouter.IndexRoute, { component: _app2.default.Creator }),
			_react2.default.createElement(_reactRouter.Route, { path: ":id", component: (0, _recompose.compose)((0, _recompose2.withQuery)(function (_ref8) {
					var id = _ref8.params.id;
					return {
						variables: {
							id: id
						},
				...
				}), (0, _reactRedux.connect)(function (_ref9) {
					var current = _ref9.qili.current;
		...
		_react2.default.createElement(_reactRouter.Route, { path: "comment/:id", component: (0, _recompose.compose)((0, _recompose2.withPagination)(function (_ref11) {
				var parent = _ref11.params.id;
				return {
				...
				} }), (0, _recompose.withProps)(function (_ref12) {
				var parent = _ref12.params.id;
				return {
					parent: parent,
					connection: "main_app_comments"
				};
			}), withCurrent())(_comment2.default) }),
		_react2.default.createElement(_reactRouter.Route, { path: "cloud", component: (0, _recompose.compose)((0, _recompose.getContext)({ client: _react.PropTypes.object }), (0, _reactRedux.connect)(function (_ref13, _ref14) {
