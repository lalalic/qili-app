...
var router = _react2.default.createElement(
	...
	_react2.default.createElement(
		...
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: "app" },
			_react2.default.createElement(_reactRouter.IndexRoute, { component: (0, _recompose.compose)((0, _recompose.getContext)({ router: _react.PropTypes.object }), (0, _recompose.mapProps)(function (_ref11) {
					var router = _ref11.router,
					    others = _objectWithoutProperties(_ref11, ["router"]);
			...
			_react2.default.createElement(_reactRouter.Route, { path: ":id", component: (0, _recompose.compose)((0, _recompose2.withQuery)(function (_ref12) {
					var id = _ref12.params.id;
					return {
						variables: {
							id: id
						},
				...
				}), (0, _reactRedux.connect)(function (_ref13) {
					var current = _ref13.qili.current;
					return { current: current };
				}), (0, _recompose.getContext)({
					client: _react.PropTypes.object,
					router: _react.PropTypes.object
				}), (0, _recompose.withProps)(function (_ref14) {
					var me = _ref14.me,
		...
		_react2.default.createElement(_reactRouter.Route, { path: "comment/:id", component: (0, _recompose.compose)((0, _recompose2.withPagination)(function (_ref15) {
				var parent = _ref15.params.id;
				return {
				...
				} }), (0, _recompose.withProps)(function (_ref16) {
		...
		_react2.default.createElement(_reactRouter.Route, { path: "cloud", component: (0, _recompose.compose)((0, _recompose.getContext)({ client: _react.PropTypes.object }), (0, _reactRedux.connect)(function (_ref17, _ref18) {
				var current = _ref17.qili.current;
				var client = _ref18.client;
				return {
					id: current,
