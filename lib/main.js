...
var QiliAdmin = (0, _recompose.compose)((0, _recompose.withProps)(function () {
	return {
		...
		supportOffline: new QiliAdminOffline("qiliAdmin", require("imports-loader?Cloud=../src/tools/offline/schema!../cloud").makeSchema(require("text-loader!../schema.graphql"), {
			User: {
